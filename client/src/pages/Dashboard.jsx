...
//           await Promise.all([
//             axios.get("https://readaround.onrender.com:7000/api/user/dashboard", {
//               headers: { Authorization: `Bearer ${token}` }
//             }),
//             axios.get("https://readaround.onrender.com:7000/api/books/recent", {
//               headers: { Authorization: `Bearer ${token}` }
//             }),
//             axios.get("https://readaround.onrender.com:7000/api/recommendations", {
//               headers: { Authorization: `Bearer ${token}` }
//             }),
//             axios.get("https://readaround.onrender.com:7000/api/reviews/recent", {
//               headers: { Authorization: `Bearer ${token}` }
//             })
//           ]);
...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await axios.get(`https://readaround.onrender.com:7000/api/user/details?id=${user_id}`);
  ...
  const fetchReviews = async () => {
    try {
      const response = await axios.get(`https://readaround.onrender.com:7000/api/review/get?id=${user_id}`);
    ...
    const fetchSocialData = async () => {
      try {
        const [followersRes, followingRes] = await Promise.all([
          axios.get(`https://readaround.onrender.com:7000/api/social/${user_id}/followers`),
          axios.get(`https://readaround.onrender.com:7000/api/social/${user_id}/following`),
        ]);
...
const handleSaveClick = async (reviewId) => {
    try {
      const response = await axios.put(`https://readaround.onrender.com:7000/api/review/${reviewId}`, {
        text: editedText,
        rating: editedRating,
      });
...
const handleDeleteClick = async (reviewId) => {
  if (window.confirm("Are you sure you want to delete this review?")) {
    try {
      ...
      await axios.delete(`https://readaround.onrender.com:7000/api/review/${reviewId}`);
...
const handleDeleteBook = async (bookId) => {
  if (window.confirm("Are you sure you want to remove this book from your saved list?")) {
    try {
      ...
      await axios.delete("https://readaround.onrender.com:7000/api/delete/saved", {
...
const handleUsernameClick = async (userId) => {
  try {
    const response = await axios.get(`https://readaround.onrender.com:7000/api/user/details?id=${userId}`);
...
useEffect(() => {
  const fetchFollowedRecommendations = async () => {
    try {
      const response = await axios.get(`https://readaround.onrender.com:7000/api/recommend/recommendations/${user_id}`);
      ...
      //   axios.get(`https://readaround.onrender.com:7000/api/books/${rec.book}`)
      // );
      // const userRequests = recommendationsData.map((rec) =>
      //   axios.get(`https://readaround.onrender.com:7000/api/user/details?id=${rec.recommended_by}`)
      // );
  ...
  const handleDelete = async (recommendationId) => {
    try {      
      await axios.delete(`https://readaround.onrender.com:7000/api/recommend/recommendations/${recommendationId}`);
