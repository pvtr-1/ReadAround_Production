...
const AdminPanel = () => {
  ...
  const fetchUserReviewsAndComments = async (userId) => {
    try {
      const [reviewsResponse, commentsResponse] = await Promise.all([
        axiosInstance.get(`https://readaround.onrender.com:7000/api/review/get/?id=${userId}`),
        axiosInstance.get(`https://readaround.onrender.com:7000/api/review/comments/${userId}`),
      ]);
  ...
  const handleDeleteReview = async (reviewId) => {
    try {
      await axiosInstance.delete(`https://readaround.onrender.com:7000/api/review/${reviewId}`);
  ...
  const handleDeleteComment = async (commentId) => {
    try {
      await axiosInstance.delete(`https://readaround.onrender.com:7000/api/review/${commentId}/comment`);
