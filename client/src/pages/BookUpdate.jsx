...
const BookUpdate = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axios.put(`https://readaround.onrender.com:7000/api/books/${selectedBook.id}`, formData);
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`https://readaround.onrender.com:7000/api/books/${selectedBook.id}`);
